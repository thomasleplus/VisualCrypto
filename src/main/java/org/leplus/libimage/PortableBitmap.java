...
public class PortableBitmap implements Cloneable {
  ...
  public void drawFilled(final boolean b, final Polygon2D pg) {
    ...
    floodFill(
        b,
        (int) StrictMath.rint(pg.getCenter().getX()),
        (int) StrictMath.rint(pg.getCenter().getY()));
  }
  ...
  public boolean equals(Object obj) {
    ...
    return height == other.height && Arrays.deepEquals(table, other.table) && width == other.width;
  }
