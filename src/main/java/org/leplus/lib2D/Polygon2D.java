...
public class Polygon2D {
  ...
  /**
   * Un triangle équilatéral de côté 1. (0.0, 1.0/sqrt(3)) (-0.5, -0.5/sqrt(3)) (0.5, -0.5/sqrt(3))
   */
  public static final Polygon2D TRIANGLE =
      new Polygon2D(
          new Point2D(0, 0),
  ...
  public static final Polygon2D SQUARE =
      new Polygon2D(
          new Point2D(0, 0),
          new Point2D(0.5, 0.5),
          new Point2D(-0.5, 0.5),
  ...
  /**
   * Construit un polygone régulier centré en (0, 0) et de n sommets (au moins 3), le premier sommet
   * étant toujours placé en (0, 1) et les suivants dans le sens trigonométrique.
   *
  ...
  public Polygon2D(
      final Point2D center, final Point2D a, final Point2D b, final Point2D c, final Point2D d) {
  ...
  /**
   * Construit un polygone dont les sommets sont les points donnés (le premier point est le centre
   * et les points suivants sont les sommets successifs).
   *
  ...
  /**
   * Applique la matrice de transformation donnée au polygone et retourne le résultat.
   *
